...
{
    /// <summary>
    /// This example shows how different flatbuffer files can include each other. In this example, IncludesExample.fbs references A, which references B, which is in a subdirectory.
