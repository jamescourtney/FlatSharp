...
public struct StructVectors : IFlatbufferObject
{
  ...
  public FlatSharpEndToEndTests.Oracle.Flatc.FiveByteStruct AlignmentVec(int j) { return (new FlatSharpEndToEndTests.Oracle.Flatc.FiveByteStruct()).__assign(__p.bb_pos + 0 + j * 8, __p.bb); }
  public ulong HashVec(int j) { return __p.bb.GetUlong(__p.bb_pos + 24 + j * 8); }

  public static Offset<FlatSharpEndToEndTests.Oracle.Flatc.StructVectors> CreateStructVectors(FlatBufferBuilder builder, int[] AlignmentVec_Int, byte[] AlignmentVec_Byte, ulong[] HashVec) {
    builder.Prep(8, 56);
    ...
    return new Offset<FlatSharpEndToEndTests.Oracle.Flatc.StructVectors>(builder.Offset);
  }
  ...
  public void UnPackTo(StructVectorsT _o) {
    _o.AlignmentVec = new FlatSharpEndToEndTests.Oracle.Flatc.FiveByteStructT[3];
  ...
  public static Offset<FlatSharpEndToEndTests.Oracle.Flatc.StructVectors> Pack(FlatBufferBuilder builder, StructVectorsT _o) {
    if (_o == null) return default(Offset<FlatSharpEndToEndTests.Oracle.Flatc.StructVectors>);
...
{
  public FlatSharpEndToEndTests.Oracle.Flatc.FiveByteStructT[] AlignmentVec { get; set; }
  public ulong[] HashVec { get; set; }

  public StructVectorsT() {
    this.AlignmentVec = new FlatSharpEndToEndTests.Oracle.Flatc.FiveByteStructT[3];
