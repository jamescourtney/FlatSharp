...
public struct UnionVectorTable : IFlatbufferObject
{
  ...
  public static Offset<FlatSharpEndToEndTests.Oracle.Flatc.UnionVectorTable> CreateUnionVectorTable(FlatBufferBuilder builder,
  ...
  public static Offset<FlatSharpEndToEndTests.Oracle.Flatc.UnionVectorTable> EndUnionVectorTable(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatSharpEndToEndTests.Oracle.Flatc.UnionVectorTable>(o);
  }
  ...
  public static Offset<FlatSharpEndToEndTests.Oracle.Flatc.UnionVectorTable> Pack(FlatBufferBuilder builder, UnionVectorTableT _o) {
    if (_o == null) return default(Offset<FlatSharpEndToEndTests.Oracle.Flatc.UnionVectorTable>);
