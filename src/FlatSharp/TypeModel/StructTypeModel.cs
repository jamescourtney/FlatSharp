...
public class StructTypeModel : RuntimeTypeModel
{
    ...
    public override CodeGeneratedMethod CreateParseMethodBody(ParserCodeGenContext context)
    {
        ...
        return new CodeGeneratedMethod($"return {className}<{context.InputBufferTypeName}>.GetOrCreate({context.InputBufferVariableName}, {context.OffsetVariableName}, {context.ObjectDepthLimitVariableName});")
        {
