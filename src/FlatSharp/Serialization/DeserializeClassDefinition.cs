        ...
        public override string ToString()
        {
            ...
            $@"
                ...
                {{
                    ...
                    bool {nameof(IFlatBufferDeserializedObject)}.{nameof(IFlatBufferDeserializedObject.CanSerializeWithMemoryCopy)} => {this.options.CanSkipSerialize.ToString().ToLowerInvariant()};
