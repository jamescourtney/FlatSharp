        ...
        public override string ToString()
        {
            ...
            $@"
                ...
                {{
                    ...
                    bool {nameof(IFlatBufferDeserializedObject)}.{nameof(IFlatBufferDeserializedObject.CanSkipSerialize)} => {this.options.CanSkipSerialize.ToString().ToLowerInvariant()};
