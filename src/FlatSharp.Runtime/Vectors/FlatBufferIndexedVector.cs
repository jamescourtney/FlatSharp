...
namespace FlatSharp
{
    ...
    public class FlatBufferIndexedVector<TKey, TValue, TInputBuffer> : IIndexedVector<TKey, TValue>
        where TValue : class
        where TKey : notnull
        where TInputBuffer : IInputBuffer
    {
        private readonly FlatBufferVector<TValue, TInputBuffer> vector;

        public FlatBufferIndexedVector(FlatBufferVector<TValue, TInputBuffer> vector)
        {
            this.vector = vector;
        }
