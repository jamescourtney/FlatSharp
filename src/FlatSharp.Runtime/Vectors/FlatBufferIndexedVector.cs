...
/// </summary>
public class FlatBufferIndexedVector<TKey, TValue, TInputBuffer, TVectorItemAccessor, TActualType> : IIndexedVector<TKey, TValue>
    where TValue : class
    where TKey : notnull
...
{
    private readonly FlatBufferVectorBase<TValue, TInputBuffer, TVectorItemAccessor, TActualType> vector;

    public FlatBufferIndexedVector(FlatBufferVectorBase<TValue, TInputBuffer, TVectorItemAccessor, TActualType> vector)
    {
        this.vector = vector;
    }
