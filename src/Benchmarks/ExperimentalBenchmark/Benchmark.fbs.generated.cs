...
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the FlatSharp FBS to C# compiler (source hash: 5.3.0.MbAdyYEuvCj9iUBj8/N+NXkhwQUHzAhCoBgWtejRnC4=)
//
...
{
    internal static class CloneHelpers_aa168985ccb54fd797100c54c23e338b
    {
...
#pragma warning restore CS8618
        public SomeTable(SomeTable source)
        {
            checked
            {
                this.Struct = FlatSharp.Compiler.Generated.CloneHelpers_aa168985ccb54fd797100c54c23e338b.Clone(source.Struct);
                this.OnInitialized(null);
            }
        }
        ...
        private sealed class GeneratedSerializer : IGeneratedSerializer<BenchmarkCore.SomeTable>
        {
                ...
                where TSpanWriter : ISpanWriter
            {
                checked
                {
                    WriteInlineValueOf_0e212467e7a844d9b75fa01ddbf3f4f0(writer, target, root, offset, context);
                }
            }
            ...
            public int GetMaxSize(BenchmarkCore.SomeTable root)
            {
                checked
                {
                    return GetMaxSizeOf_0e212467e7a844d9b75fa01ddbf3f4f0(root);
                }
            }
                ...
                where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return Read_0e212467e7a844d9b75fa01ddbf3f4f0(buffer, offset);
                }
            }

            private static int GetMaxSizeOf_0e212467e7a844d9b75fa01ddbf3f4f0(BenchmarkCore.SomeTable value)
            {
                checked
                {
            ...
            private static BenchmarkCore.SomeTable Read_0e212467e7a844d9b75fa01ddbf3f4f0<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return new tableReader_ad1e8110b0344462999aa4844b9e2b1b<TInputBuffer>(buffer, offset + buffer.ReadUOffset(offset));
                }
            }

            private sealed class tableReader_ad1e8110b0344462999aa4844b9e2b1b<TInputBuffer>
                ...
                where TInputBuffer : IInputBuffer
            {
                ...
                public tableReader_ad1e8110b0344462999aa4844b9e2b1b(TInputBuffer buffer, int offset) : base(__CtorContext)
                {
                    checked
                    {
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        ...
                        return Read_5ee70ccccf5b4893a5a91b36ca67fa67(buffer, absoluteLocation); ;
                    }
                }
            }
            ...
            private static void WriteInlineValueOf_0e212467e7a844d9b75fa01ddbf3f4f0<TSpanWriter>(
                ...
                , SerializationContext context) where TSpanWriter : ISpanWriter
            {
                checked
                {
                    ...
                    if (!(index0Value is null))
                    {
                        ...
                        WriteInlineValueOf_5ee70ccccf5b4893a5a91b36ca67fa67(spanWriter, span, index0Value!, index0Offset);
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_5ee70ccccf5b4893a5a91b36ca67fa67(BenchmarkCore.Struct value)
            {
                checked
                {
                    return 19;
            ...
            private static BenchmarkCore.Struct Read_5ee70ccccf5b4893a5a91b36ca67fa67<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return new structReader_2df4013bf6e145f99be5e0adb6a615d4<TInputBuffer>(buffer, offset);
                }
            }

            private sealed class structReader_2df4013bf6e145f99be5e0adb6a615d4<TInputBuffer>
                ...
                where TInputBuffer : IInputBuffer
            {
                ...
                public structReader_2df4013bf6e145f99be5e0adb6a615d4(TInputBuffer buffer, int offset) : base(__CtorContext)
                {
                    checked
                    {
                        this.__buffer = buffer;
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_16c65a6763f64351b9c8a23f43e2b23c(buffer, offset + 0); ;
                    }
                }
                    ...
                    BenchmarkCore.OtherStruct value)
                {
                    checked
                    {
                        ...
                        WriteInlineValueOf_16c65a6763f64351b9c8a23f43e2b23c(
                            default(SpanWriter),
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_6cfe67954c2b4b5fae6dd73705279c9b(buffer, offset + 8); ;
                    }
                }
                    ...
                    System.Int32 value)
                {
                    checked
                    {
                        ...
                        WriteInlineValueOf_6cfe67954c2b4b5fae6dd73705279c9b(
                            default(SpanWriter),
                            buffer.GetByteMemory(0, buffer.Length).Span,
                            value,
                            offset + 8);
            ...
            private static void WriteInlineValueOf_5ee70ccccf5b4893a5a91b36ca67fa67<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                ...
                ) where TSpanWriter : ISpanWriter
            {
                checked
                {
                    ...
                    WriteInlineValueOf_16c65a6763f64351b9c8a23f43e2b23c(spanWriter, scopedSpan, value.Other, 0);
                    WriteInlineValueOf_6cfe67954c2b4b5fae6dd73705279c9b(spanWriter, scopedSpan, value.Int, 8);
                }
            }

            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_16c65a6763f64351b9c8a23f43e2b23c(BenchmarkCore.OtherStruct value)
            {
                checked
                {
                    return 15;
            ...
            private static BenchmarkCore.OtherStruct Read_16c65a6763f64351b9c8a23f43e2b23c<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return new structReader_1de7c21e5c624dd58ad37864a9d4a08c<TInputBuffer>(buffer, offset);
                }
            }

            private sealed class structReader_1de7c21e5c624dd58ad37864a9d4a08c<TInputBuffer>
                ...
                where TInputBuffer : IInputBuffer
            {
                ...
                public structReader_1de7c21e5c624dd58ad37864a9d4a08c(TInputBuffer buffer, int offset) : base(__CtorContext)
                {
                    checked
                    {
                        this.__buffer = buffer;
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_72efa038ccbe421f9050c8b853200b6a(buffer, offset + 0); ;
                    }
                }
                    ...
                    System.Int64 value)
                {
                    checked
                    {
                        ...
                        WriteInlineValueOf_72efa038ccbe421f9050c8b853200b6a(
                            default(SpanWriter),
                            buffer.GetByteMemory(0, buffer.Length).Span,
                            value,
                            offset + 0);
            ...
            private static void WriteInlineValueOf_16c65a6763f64351b9c8a23f43e2b23c<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                BenchmarkCore.OtherStruct value,
                int offset
                ) where TSpanWriter : ISpanWriter
            {
                checked
                {
                    ...
                    WriteInlineValueOf_72efa038ccbe421f9050c8b853200b6a(spanWriter, scopedSpan, value.Long, 0);
                }
            }

            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_72efa038ccbe421f9050c8b853200b6a(System.Int64 value)
            {
                checked
                {
                    return 15;
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static System.Int64 Read_72efa038ccbe421f9050c8b853200b6a<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
            ...
            private static void WriteInlineValueOf_72efa038ccbe421f9050c8b853200b6a<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                System.Int64 value,
                int offset
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_6cfe67954c2b4b5fae6dd73705279c9b(System.Int32 value)
            {
                checked
                {
                    return 7;
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static System.Int32 Read_6cfe67954c2b4b5fae6dd73705279c9b<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private static void WriteInlineValueOf_6cfe67954c2b4b5fae6dd73705279c9b<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                System.Int32 value,
                int offset
...
#pragma warning restore CS8618
        public Struct(Struct source)
        {
            checked
            {
                this.Other = FlatSharp.Compiler.Generated.CloneHelpers_aa168985ccb54fd797100c54c23e338b.Clone(source.Other);
                this.Int = FlatSharp.Compiler.Generated.CloneHelpers_aa168985ccb54fd797100c54c23e338b.Clone(source.Int);
                this.OnInitialized(null);
            }
        }
...
#pragma warning restore CS8618
        public OtherStruct(OtherStruct source)
        {
            checked
            {
                this.Long = FlatSharp.Compiler.Generated.CloneHelpers_aa168985ccb54fd797100c54c23e338b.Clone(source.Long);
                this.OnInitialized(null);
            }
        }
