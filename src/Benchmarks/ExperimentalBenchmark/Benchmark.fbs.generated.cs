...
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the FlatSharp FBS to C# compiler (source hash: 5.4.0.cJGcgq3xX20mkTuQd++0d3m6Cm+/KJjGmN/VObJF0BY=)
//
...
{
    internal static class CloneHelpers_df49d8a38a924537b4e63c4067f85538
    {
        ...
        public static System.Collections.Generic.IList<BenchmarkCore.Vec3>? Clone(System.Collections.Generic.IList<BenchmarkCore.Vec3>? item)
        {
            checked
            {
                return VectorCloneHelpers.Clone<BenchmarkCore.Vec3>(item, FlatSharp.Compiler.Generated.CloneHelpers_df49d8a38a924537b4e63c4067f85538.Clone);
            }
        }
...
#pragma warning restore CS8618
        public SomeTable(SomeTable source)
        {
            checked
            {
                this.Points = FlatSharp.Compiler.Generated.CloneHelpers_df49d8a38a924537b4e63c4067f85538.Clone(source.Points);
                this.OnInitialized(null);
            }
        }
        ...
        private sealed class GeneratedSerializer : IGeneratedSerializer<BenchmarkCore.SomeTable>
        {
                ...
                where TSpanWriter : ISpanWriter
            {
                checked
                {
                    WriteInlineValueOf_5635cf702cd24d6c9b8fda45a7c6389a(writer, target, root, offset, context);
                }
            }
            ...
            public int GetMaxSize(BenchmarkCore.SomeTable root)
            {
                checked
                {
                    return GetMaxSizeOf_5635cf702cd24d6c9b8fda45a7c6389a(root);
                }
            }
                ...
                where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return Read_5635cf702cd24d6c9b8fda45a7c6389a(buffer, offset);
                }
            }

            private static int GetMaxSizeOf_5635cf702cd24d6c9b8fda45a7c6389a(BenchmarkCore.SomeTable value)
            {
                checked
                {
                    ...
                    {
                        runningSum += GetMaxSizeOf_b1237c12ef0749c8a0c90a14de2c628a(index0Value);
                    };
                    return runningSum;
            ...
            private static BenchmarkCore.SomeTable Read_5635cf702cd24d6c9b8fda45a7c6389a<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return tableReader_72ec8ee686c646d2ae21b0d1355e61a5<TInputBuffer>.GetOrCreate(buffer, offset + buffer.ReadUOffset(offset));
                }
            }

            private sealed class tableReader_72ec8ee686c646d2ae21b0d1355e61a5<TInputBuffer>
                ...
                where TInputBuffer : IInputBuffer
            {
                private static readonly FlatSharp.FlatBufferDeserializationContext __CtorContext
                    = new FlatSharp.FlatBufferDeserializationContext(FlatSharp.FlatBufferDeserializationOption.Lazy);
                ...
                public static tableReader_72ec8ee686c646d2ae21b0d1355e61a5<TInputBuffer> GetOrCreate(TInputBuffer buffer, int offset)
                {
                    checked
                    {

                        var item = new tableReader_72ec8ee686c646d2ae21b0d1355e61a5<TInputBuffer>(buffer, offset);
                        return item;

                    }
                }

                private tableReader_72ec8ee686c646d2ae21b0d1355e61a5(TInputBuffer buffer, int offset) : base(__CtorContext)
                {
                    checked
                    {
                ...
                public override System.Collections.Generic.IList<BenchmarkCore.Vec3>? Points
                {
                    get
                    {
                        checked
                        {
                            return ReadIndex0Value(this.__buffer, this.__offset, this.__vtableOffset, this.__vtableMaxIndex);
                        }
                    }
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        ...
                        return Read_b1237c12ef0749c8a0c90a14de2c628a(buffer, absoluteLocation); ;
                    }
                }
            }
            ...
            private static void WriteInlineValueOf_5635cf702cd24d6c9b8fda45a7c6389a<TSpanWriter>(
                ...
                , SerializationContext context) where TSpanWriter : ISpanWriter
            {
                checked
                {
                    ...
                    if (index0Offset != tableStart)
                    {
                        ...
                        WriteInlineValueOf_b1237c12ef0749c8a0c90a14de2c628a(spanWriter, span, index0Value!, index0Offset, context);
            ...
            private static int GetMaxSizeOf_b1237c12ef0749c8a0c90a14de2c628a(System.Collections.Generic.IList<BenchmarkCore.Vec3> value)
            {
                checked
                {
            ...
            private static System.Collections.Generic.IList<BenchmarkCore.Vec3> Read_b1237c12ef0749c8a0c90a14de2c628a<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return new FlatBufferVector_7e70523b51a04750ae07d56dd930352c<TInputBuffer>(
                        buffer,
            ...
            public sealed class FlatBufferVector_7e70523b51a04750ae07d56dd930352c<TInputBuffer> : FlatBufferVector<BenchmarkCore.Vec3, TInputBuffer>
                where TInputBuffer : IInputBuffer
            {
                public FlatBufferVector_7e70523b51a04750ae07d56dd930352c(
                    TInputBuffer memory,
                    int offset,
                ...
                protected override BenchmarkCore.Vec3 ParseItem(TInputBuffer memory, int offset)
                {
                    checked
                    {
                        return Read_0d4075cb651d47ddb4e886f329e12db0(memory, offset);
                    }
                }
            }
            ...
            private static void WriteInlineValueOf_b1237c12ef0749c8a0c90a14de2c628a<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                ...
                checked
                {
                    ...
                    if (value is BenchmarkCore.Vec3[] array)
                    {
                        ...
                        for (int i = 0; i < array.Length; i = unchecked(i + 1))
                        {
                            ...
                            WriteInlineValueOf_0d4075cb651d47ddb4e886f329e12db0(spanWriter, span, current, vectorOffset);
                            vectorOffset += 12;
                        }
                    }
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_0d4075cb651d47ddb4e886f329e12db0(BenchmarkCore.Vec3 value)
            {
                checked
                {
                    return 15;
            ...
            private static BenchmarkCore.Vec3 Read_0d4075cb651d47ddb4e886f329e12db0<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return structReader_fdb8f700a8a34467b32a69add665856c<TInputBuffer>.GetOrCreate(buffer, offset);
                }
            }

            private sealed class structReader_fdb8f700a8a34467b32a69add665856c<TInputBuffer>
                : BenchmarkCore.Vec3
                , FlatSharp.IFlatBufferDeserializedObject
                where TInputBuffer : IInputBuffer
            {
                ...
                [ThreadStatic]
                private static Queue<structReader_fdb8f700a8a34467b32a69add665856c<TInputBuffer>> __Pool = new Queue<structReader_fdb8f700a8a34467b32a69add665856c<TInputBuffer>>();


                private static Queue<structReader_fdb8f700a8a34467b32a69add665856c<TInputBuffer>> __Queue => __Pool ?? (__Pool = new Queue<structReader_fdb8f700a8a34467b32a69add665856c<TInputBuffer>>());
                ...
                public static structReader_fdb8f700a8a34467b32a69add665856c<TInputBuffer> GetOrCreate(TInputBuffer buffer, int offset)
                {
                    checked
                    {
                        ...
                        {
                            item = new structReader_fdb8f700a8a34467b32a69add665856c<TInputBuffer>();
                        }
                ...
                private structReader_fdb8f700a8a34467b32a69add665856c() : base(__CtorContext)
                {
                    checked
                    {
                    }
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_7785c95c87f645538feedee9625623e0(buffer, offset + 0); ;
                    }
                }
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_7785c95c87f645538feedee9625623e0(buffer, offset + 4); ;
                    }
                }
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_7785c95c87f645538feedee9625623e0(buffer, offset + 8); ;
                    }
                }
            }
            ...
            private static void WriteInlineValueOf_0d4075cb651d47ddb4e886f329e12db0<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                ...
                ) where TSpanWriter : ISpanWriter
            {
                checked
                {
                    ...
                    WriteInlineValueOf_7785c95c87f645538feedee9625623e0(spanWriter, scopedSpan, value.X, 0);
                    WriteInlineValueOf_7785c95c87f645538feedee9625623e0(spanWriter, scopedSpan, value.Y, 4);
                    WriteInlineValueOf_7785c95c87f645538feedee9625623e0(spanWriter, scopedSpan, value.Z, 8);
                }
            }

            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_7785c95c87f645538feedee9625623e0(System.Single value)
            {
                checked
                {
                    return 7;
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static System.Single Read_7785c95c87f645538feedee9625623e0<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
            ...
            private static void WriteInlineValueOf_7785c95c87f645538feedee9625623e0<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                System.Single value,
                int offset
...
#pragma warning restore CS8618
        public Vec3(Vec3 source)
        {
            checked
            {
                this.X = FlatSharp.Compiler.Generated.CloneHelpers_df49d8a38a924537b4e63c4067f85538.Clone(source.X);
                this.Y = FlatSharp.Compiler.Generated.CloneHelpers_df49d8a38a924537b4e63c4067f85538.Clone(source.Y);
                this.Z = FlatSharp.Compiler.Generated.CloneHelpers_df49d8a38a924537b4e63c4067f85538.Clone(source.Z);
                this.OnInitialized(null);
            }
        }
...
#pragma warning restore CS8618
        public Struct(Struct source)
        {
            checked
            {
                this.Other = FlatSharp.Compiler.Generated.CloneHelpers_df49d8a38a924537b4e63c4067f85538.Clone(source.Other);
                this.Int = FlatSharp.Compiler.Generated.CloneHelpers_df49d8a38a924537b4e63c4067f85538.Clone(source.Int);
                this.OnInitialized(null);
            }
        }
...
#pragma warning restore CS8618
        public OtherStruct(OtherStruct source)
        {
            checked
            {
                this.Long = FlatSharp.Compiler.Generated.CloneHelpers_df49d8a38a924537b4e63c4067f85538.Clone(source.Long);
                this.OnInitialized(null);
            }
        }
