...
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the FlatSharp FBS to C# compiler (source hash: 5.2.1.MbAcyYAuvCj9iUBj8/N+NXkhwQUHzAhCoBgWtejRnC4=)
//
...
{
    internal static class CloneHelpers_1df70e7b58c64c3292fa9df7982d0c63
    {
...
#pragma warning restore CS8618
        public SomeTable(SomeTable source)
        {
            checked
            {
                this.Struct = FlatSharp.Compiler.Generated.CloneHelpers_1df70e7b58c64c3292fa9df7982d0c63.Clone(source.Struct);
                this.OnInitialized(null);
            }
        }
        ...
        private sealed class GeneratedSerializer : IGeneratedSerializer<BenchmarkCore.SomeTable>
        {
                ...
                where TSpanWriter : ISpanWriter
            {
                checked
                {
                    WriteInlineValueOf_306f4610f28e4256875bb34b5721d34b(writer, target, root, offset, context);
                }
            }
            ...
            public int GetMaxSize(BenchmarkCore.SomeTable root)
            {
                checked
                {
                    return GetMaxSizeOf_306f4610f28e4256875bb34b5721d34b(root);
                }
            }
                ...
                where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return Read_306f4610f28e4256875bb34b5721d34b(buffer, offset);
                }
            }

            private static int GetMaxSizeOf_306f4610f28e4256875bb34b5721d34b(BenchmarkCore.SomeTable value)
            {
                checked
                {
            ...
            private static BenchmarkCore.SomeTable Read_306f4610f28e4256875bb34b5721d34b<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return new tableReader_d40d502c63a9433b940dc973c3215826<TInputBuffer>(buffer, offset + buffer.ReadUOffset(offset));
                }
            }

            private sealed class tableReader_d40d502c63a9433b940dc973c3215826<TInputBuffer>
                ...
                where TInputBuffer : IInputBuffer
            {
                ...
                public tableReader_d40d502c63a9433b940dc973c3215826(TInputBuffer buffer, int offset) : base(__CtorContext)
                {
                    checked
                    {
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        ...
                        return Read_8ec03dc461dc4c3eafff030cebe2736c(buffer, absoluteLocation); ;
                    }
                }
            }
            ...
            private static void WriteInlineValueOf_306f4610f28e4256875bb34b5721d34b<TSpanWriter>(
                ...
                , SerializationContext context) where TSpanWriter : ISpanWriter
            {
                checked
                {
                    ...
                    if (!(index0Value is null))
                    {
                        ...
                        WriteInlineValueOf_8ec03dc461dc4c3eafff030cebe2736c(spanWriter, span, index0Value!, index0Offset);
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_8ec03dc461dc4c3eafff030cebe2736c(BenchmarkCore.Struct value)
            {
                checked
                {
                    return 19;
            ...
            private static BenchmarkCore.Struct Read_8ec03dc461dc4c3eafff030cebe2736c<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return new structReader_0fc6b8409825435d8564aa9bf81dd004<TInputBuffer>(buffer, offset);
                }
            }

            private sealed class structReader_0fc6b8409825435d8564aa9bf81dd004<TInputBuffer>
                ...
                where TInputBuffer : IInputBuffer
            {
                ...
                public structReader_0fc6b8409825435d8564aa9bf81dd004(TInputBuffer buffer, int offset) : base(__CtorContext)
                {
                    checked
                    {
                        this.__buffer = buffer;
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_03a50375d4a74d5897794d191f0b4f09(buffer, offset + 0); ;
                    }
                }
                    ...
                    BenchmarkCore.OtherStruct value)
                {
                    checked
                    {
                        ...
                        WriteInlineValueOf_03a50375d4a74d5897794d191f0b4f09(
                            default(SpanWriter),
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_fd33f4666f924a4695a6e94dc7309a41(buffer, offset + 8); ;
                    }
                }
                    ...
                    System.Int32 value)
                {
                    checked
                    {
                        ...
                        WriteInlineValueOf_fd33f4666f924a4695a6e94dc7309a41(
                            default(SpanWriter),
                            buffer.GetByteMemory(0, buffer.Length).Span,
                            value,
                            offset + 8);
            ...
            private static void WriteInlineValueOf_8ec03dc461dc4c3eafff030cebe2736c<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                ...
                ) where TSpanWriter : ISpanWriter
            {
                checked
                {
                    ...
                    WriteInlineValueOf_03a50375d4a74d5897794d191f0b4f09(spanWriter, scopedSpan, value.Other, 0);
                    WriteInlineValueOf_fd33f4666f924a4695a6e94dc7309a41(spanWriter, scopedSpan, value.Int, 8);
                }
            }

            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_03a50375d4a74d5897794d191f0b4f09(BenchmarkCore.OtherStruct value)
            {
                checked
                {
                    return 15;
            ...
            private static BenchmarkCore.OtherStruct Read_03a50375d4a74d5897794d191f0b4f09<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
                {
                    return new structReader_5c98b52b5f324df384c4939c7827ca8b<TInputBuffer>(buffer, offset);
                }
            }

            private sealed class structReader_5c98b52b5f324df384c4939c7827ca8b<TInputBuffer>
                ...
                where TInputBuffer : IInputBuffer
            {
                ...
                public structReader_5c98b52b5f324df384c4939c7827ca8b(TInputBuffer buffer, int offset) : base(__CtorContext)
                {
                    checked
                    {
                        this.__buffer = buffer;
                    ...
                    int maxVtableIndex)
                {
                    checked
                    {
                        return Read_678c523c4a3d4e589c7d635a9f9d006a(buffer, offset + 0); ;
                    }
                }
                    ...
                    System.Int64 value)
                {
                    checked
                    {
                        ...
                        WriteInlineValueOf_678c523c4a3d4e589c7d635a9f9d006a(
                            default(SpanWriter),
                            buffer.GetByteMemory(0, buffer.Length).Span,
                            value,
                            offset + 0);
            ...
            private static void WriteInlineValueOf_03a50375d4a74d5897794d191f0b4f09<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                BenchmarkCore.OtherStruct value,
                int offset
                ) where TSpanWriter : ISpanWriter
            {
                checked
                {
                    ...
                    WriteInlineValueOf_678c523c4a3d4e589c7d635a9f9d006a(spanWriter, scopedSpan, value.Long, 0);
                }
            }

            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_678c523c4a3d4e589c7d635a9f9d006a(System.Int64 value)
            {
                checked
                {
                    return 15;
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static System.Int64 Read_678c523c4a3d4e589c7d635a9f9d006a<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
            ...
            private static void WriteInlineValueOf_678c523c4a3d4e589c7d635a9f9d006a<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                System.Int64 value,
                int offset
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static int GetMaxSizeOf_fd33f4666f924a4695a6e94dc7309a41(System.Int32 value)
            {
                checked
                {
                    return 7;
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            private static System.Int32 Read_fd33f4666f924a4695a6e94dc7309a41<TInputBuffer>(
                TInputBuffer buffer,
                int offset) where TInputBuffer : IInputBuffer
            {
                checked
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private static void WriteInlineValueOf_fd33f4666f924a4695a6e94dc7309a41<TSpanWriter>(
                TSpanWriter spanWriter,
                Span<byte> span,
                System.Int32 value,
                int offset
...
#pragma warning restore CS8618
        public Struct(Struct source)
        {
            checked
            {
                this.Other = FlatSharp.Compiler.Generated.CloneHelpers_1df70e7b58c64c3292fa9df7982d0c63.Clone(source.Other);
                this.Int = FlatSharp.Compiler.Generated.CloneHelpers_1df70e7b58c64c3292fa9df7982d0c63.Clone(source.Int);
                this.OnInitialized(null);
            }
        }
...
#pragma warning restore CS8618
        public OtherStruct(OtherStruct source)
        {
            checked
            {
                this.Long = FlatSharp.Compiler.Generated.CloneHelpers_1df70e7b58c64c3292fa9df7982d0c63.Clone(source.Long);
                this.OnInitialized(null);
            }
        }
